#!/usr/bin/env python3
"""Auditoría del bloque 01 del catálogo JMA C12."""
...
INPUT = Path(__file__).parent / "jma_c12_catalog_part_01.json"
OUT_JSON = Path(__file__).parent / "jma_c12_catalog_part_01_audit.json"
OUT_MD = Path(__file__).parent / "jma_c12_catalog_part_01_audit.md"
...
def main():
    ...
    # Generar audit MD
    lines = [
        "# Auditoría: jma_c12_catalog_part_01.json",
        "",
        "## 1. id_model_ref únicos",
    ...
    lines.append("")
    lines.append("---")
    lines.append("*Generado por audit_block_01.py*")
